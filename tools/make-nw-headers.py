...
group.add_argument('-n','--name', help='platform name.', required=False)
...
if platform_name == 'win':
  ...
  shutil.copyfile(os.path.join(binaries_location, 'nw.lib'), release_dir)
  shutil.copyfile(os.path.join(binaries_location, 'node.lib'), release_dir)
